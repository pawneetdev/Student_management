...
public class teacherpage extends JFrame implements ActionListener
{
    ...
    public teacherpage()
    {
        ...
        try
        {
            ...
            ResultSet rs = stmt.executeQuery("SELECT id FROM login WHERE admin = 0");
            ...
            b2.setBounds(new Rectangle(100,70+38*p,105,25));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {       
                ...
                editframe = new JFrame("Modify teacher's detail");
                ...
                b1.setBounds(new Rectangle(30,260,80,25));
                b1.addActionListener(this);
                b5 = new JButton("Cancel");
                b5.setBounds(new Rectangle(130,260,80,25));
                b5.addActionListener(this);
                b6 = new JButton("Allot classes");
                b6.setBounds(new Rectangle(60,300,120,25));
                ...
                try
                {
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/student","root","");
                    Statement stmt = con.createStatement();
                    ResultSet rs = stmt.executeQuery("SELECT username, password, name, subject, id FROM login WHERE id = '"+label[i].getText()+"'");
                    while(rs.next())
                    {
                ...
                b6.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e)
                    {
                        ...
                        if (source instanceof JButton) {
                            ...
                            editframe.dispose();
                            allotclasses y = new allotclasses();
                            y.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                            y.setVisible(true);
                            y.setSize(300,300);
                        }
